...
RtmConfig _$RtmConfigFromJson(Map<String, dynamic> json) => RtmConfig(
      ...
      reconnectTimeout: (json['reconnectTimeout'] as num?)?.toInt() ?? 0,
...
Map<String, dynamic> _$RtmConfigToJson(RtmConfig instance) {
  ...
  writeNotNull('reconnectTimeout', instance.reconnectTimeout);
...
TokenEvent _$TokenEventFromJson(Map<String, dynamic> json) => TokenEvent(
      eventType:
          $enumDecodeNullable(_$RtmTokenEventTypeEnumMap, json['eventType']),
      reason: json['reason'] as String?,
      affectedResources: json['affectedResources'] == null
          ? null
          : AffectedResources.fromJson(
              json['affectedResources'] as Map<String, dynamic>),
      timestamp: (json['timestamp'] as num?)?.toInt(),
    );

Map<String, dynamic> _$TokenEventToJson(TokenEvent instance) {
  final val = <String, dynamic>{};
  ...
  writeNotNull('eventType', _$RtmTokenEventTypeEnumMap[instance.eventType]);
  writeNotNull('reason', instance.reason);
  writeNotNull('affectedResources', instance.affectedResources?.toJson());
  writeNotNull('timestamp', instance.timestamp);
  return val;
}
