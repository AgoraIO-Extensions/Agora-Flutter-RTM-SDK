...
class NativeIrisTesterRtmBinding {
  ...
  ffi.Pointer<ProcTableRtm> GetDebugProcTableRtm() {
    return _GetDebugProcTableRtm();
  }

  late final _GetDebugProcTableRtmPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ProcTableRtm> Function()>>(
          'GetDebugProcTableRtm');
  late final _GetDebugProcTableRtm = _GetDebugProcTableRtmPtr.asFunction<
      ffi.Pointer<ProcTableRtm> Function()>();
}
...
class ProcTableRtm extends ffi.Struct {
